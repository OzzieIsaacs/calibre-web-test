...
class TestEditBooks(TestCase, ui_class):
    ...
    def test_edit_title(self):
        ...
        self.get_book_details(4)
        self.check_element_on_page((By.ID, "edit_book")).click()
        self.edit_book(content={'title': u'Not found'})
        ...
        self.edit_book(content={'title': u'Very long extra super turbo cool title without any issue of displaying including ö utf-8 characters'})
        ...
        self.check_element_on_page((By.ID, "edit_book")).click()
        self.edit_book(content={'title': u'book6'})
    ...
    def test_edit_author(self):
        ...
        self.get_book_details(8)
        self.check_element_on_page((By.ID, "edit_book")).click()
        self.edit_book(content={'authors': u'Not found'})
        self.check_element_on_page((By.ID, 'flash_danger'))
        details = self.get_book_details()
        # author = self.check_element_on_page((By.ID, "authors"))
        ...
        os.renames(not_file_path, file_path)
        self.check_element_on_page((By.ID, "edit_book")).click()
        self.edit_book(content={'authors': 'Leo Baskerville'}, detail_v=True)
        self.fill_basic_config({"config_unicode_filename": 0})
        self.assertTrue(self.check_element_on_page((By.ID, "flash_success")))
    ...
    def test_edit_custom_bool(self):
        ...
        self.assertEqual(len(self.adv_search({"title": "book", 'custom_column_3': 'No'})), 1)
        self.assertEqual(len(self.adv_search({"title": "book", 'custom_column_3': 'Yes'})), 1)
        self.assertEqual(len(self.adv_search({"title": "book", })), 7)
        self.assertEqual(len(self.adv_search({"title": "book", 'custom_column_3': 'Empty'})), 5)
    ...
    def test_edit_custom_float(self):
        ...
        self.assertEqual(len(self.adv_search({'custom_column_8_high': '-2.5'})), 0)
        self.get_book_details(5)
        self.check_element_on_page((By.ID, "edit_book")).click()
        ...
        self.assertEqual(len(self.adv_search({'custom_column_8_low': '-2.5', 'custom_column_8_high': '-2.5'})), 1)
        self.assertEqual(len(self.adv_search({'custom_column_8_high': '0'})), 1)
        self.assertEqual(len(self.adv_search({'custom_column_8_high': '-2.5'})), 1)
        self.get_book_details(5)
        self.check_element_on_page((By.ID, "edit_book")).click()
    ...
    def test_edit_custom_int(self):
        ...
        self.assertEqual(len(self.adv_search({u'custom_column_4_high': u'0'})), 0)
        self.get_book_details(5)
        self.check_element_on_page((By.ID, "edit_book")).click()
        self.edit_book(custom_content={u'Custom Integer 人物': u'0'})
        vals = self.get_book_details(5)
        self.assertEqual(u'0', vals['cust_columns'][0]['value'])
        self.assertEqual(len(self.adv_search({'custom_column_4_low': '5'})), 0)
        self.assertEqual(len(self.adv_search({'custom_column_4_low': '0'})), 1)
        self.assertEqual(len(self.adv_search({'custom_column_4_low': '0', 'custom_column_4_high': '-1' })), 0)
        self.assertEqual(len(self.adv_search({'custom_column_4_low': '0', 'custom_column_4_high': '1'})), 1)
        self.assertEqual(len(self.adv_search({'custom_column_4_high': '0'})), 1)
        self.assertEqual(len(self.adv_search({'custom_column_4_high': '5'})), 1)
        self.assertEqual(len(self.adv_search({'custom_column_4_high': '-1'})), 0)
        self.assertEqual(len(self.adv_search({'custom_column_4_low': '0', 'custom_column_4_high': '0'})), 1)
        self.get_book_details(5)
        self.check_element_on_page((By.ID, "edit_book")).click()
    ...
    def test_typeahead_author(self):
        self.get_book_details(5)
        self.check_element_on_page((By.ID, "edit_book")).click()
        lang = self.check_element_on_page((By.ID, "authors"))
        lang.send_keys('&')
        time.sleep(2.5)
        ...
        self.get_book_details(5)
        self.check_element_on_page((By.ID, "edit_book")).click()
        self.edit_book(content={u'authors':u'John Döe'})
