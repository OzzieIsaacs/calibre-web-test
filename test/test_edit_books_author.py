...
class TestEditAuthors(ParallelTestCase):
    ...
    def test_change_capital_one_author_one_book(self):
        self.assertTrue(os.path.isfile(os.path.join(self.temp_dir, 'Leo Baskerville/book8 (8)',
                                                    'cover.jpg')))
        self.assertTrue(os.path.isfile(os.path.join(self.temp_dir, 'Leo Baskerville/book8 (8)',
        ...
        self.assertFalse('Leo Baskerville' in os.listdir(self.temp_dir))
        ...
        self.assertTrue(os.path.isfile(os.path.join(self.temp_dir, 'Leo Baskerville/book 9 (8)',
    ...
    def test_change_capital_one_author_two_books(self):
        ...
        self.assertTrue(os.path.isfile(os.path.join(self.temp_dir, 'Peter parker/book7 (10)',
                                                    'cover.jpg')))
        self.assertTrue(os.path.isfile(os.path.join(self.temp_dir, 'Peter parker/Very long extra super turbo cool tit (4)',
                                                    'cover.jpg')))
        self.assertTrue(os.path.isfile(os.path.join(self.temp_dir, 'Peter parker/Very long extra super turbo cool tit (4)',
                                                    'Very long extra super turbo cool title wit - Peter parker.pdf')))
        self.assertFalse('Peter Parker' in os.listdir(self.temp_dir))
        ...
        self.assertTrue(os.path.isfile(os.path.join(self.temp_dir, 'Peter Parker/book 7 (10)',
    ...
    def test_change_capital_one_author_two_books_coauthor(self):
        ...
        self.assertTrue(os.path.isfile(os.path.join(self.temp_dir, 'Norbert halagal/book11 (13)',
                                                    'cover.jpg')))
        self.assertFalse('Norbert Halagal' in os.listdir(self.temp_dir))
        details = self.get_book_details(1)
        ...
        self.assertTrue(os.path.isfile(os.path.join(self.temp_dir, 'Norbert Halagal/book 11 (13)',
    ...
    def test_change_capital_co_author(self):
        self.assertFalse(os.path.isfile(os.path.join(self.temp_dir, 'Frodo Beutlin/Der Buchtitel (1)',
                                                    'cover.jpg')))
        self.assertTrue(os.path.isfile(os.path.join(self.temp_dir, 'Frodo Beutlin/Der Buchtitel (1)',
        ...
        self.assertTrue(os.path.isfile(os.path.join(self.temp_dir, 'Frodo Beutlin/Derbook 1 (1)',
                                                    'Derbook 1 - Frodo Beutlin.txt')))
        self.assertFalse(os.path.isfile(os.path.join(self.temp_dir, 'Frodo Beutlin/Derbook 1 (1)',
                                                    'cover.jpg')))
        ret_code, content = self.download_book(1, "admin", "admin123")
        self.assertEqual(200, ret_code)
        # rename only book title
    ...
    def test_change_capital_rename_co_author(self):
        ...
        self.assertTrue(os.path.isfile(os.path.join(self.temp_dir, 'Frodo Beutlin/Der Buchtitel (1)',
                                                    'Der Buchtitel - Frodo Beutlin.txt')))
        self.assertTrue(os.path.isfile(os.path.join(self.temp_dir, 'Hector Goncalves/book9 (11)',
        ...
        self.assertTrue(os.path.isfile(os.path.join(self.temp_dir, 'Hector gonçalves/book9 (11)',
                                                    'cover.jpg')))
        self.assertFalse('Hector Gonçalves' in os.listdir(self.temp_dir))
    ...
    def test_change_capital_rename_two_co_authors(self):
        ...
        self.assertTrue(os.path.isfile(os.path.join(self.temp_dir, 'Asterix Lionherd/comicdemo (3)',
    ...
    def test_rename_tag_emphasis_mark_onupload(self):
        ...
        change_tag(os.path.join(self.temp_dir, "metadata.db"), "Georg", "Genot")
