...
class TestUserList(TestCase, ui_class):
    ...
    def test_user_list_edit_kindle(self):
        ul = self.get_user_table(1)
        self.assertEqual("muki1al@b.com", ul['table'][1]['E-Reader E-mail']['text'])
        self.edit_table_element(ul['table'][1]['E-Reader E-mail']['element'], "nuki1al@b.com")
        ul = self.get_user_table(-1)
        self.assertEqual("nuki1al@b.com", ul['table'][1]['E-Reader E-mail']['text'])
        self.edit_table_element(ul['table'][1]['E-Reader E-mail']['element'], "no_email")
        self.assertTrue("Invalid e-mail" in self.check_element_on_page((By.XPATH,
                                                          "//div[contains(@class,'editable-error-block')]")).text)
        self.check_element_on_page((By.XPATH, "//button[contains(@class,'editable-cancel')]")).click()
        self.edit_table_element(ul['table'][1]['E-Reader E-mail']['element'], "")
        ul = self.get_user_table(-1)
        self.assertEqual("+", ul['table'][1]['E-Reader E-mail']['text'])
        self.edit_table_element(ul['table'][1]['E-Reader E-mail']['element'], "muki1al@b.com")
        ul = self.get_user_table(-1)
        self.assertEqual("muki1al@b.com", ul['table'][1]['E-Reader E-mail']['text'])
    ...
    def test_user_list_search(self):
        ...
        self.check_search(ul, "m11", 1, "E-Reader E-mail", "m11uklial@bds.com")
    ...
    def test_user_list_sort(self):
        ...
        self.assertEqual("E-Reader E-mail", ul['header'][4]['text'])
        ul['header'][4]['sort'].click()
        ul = self.get_user_table(-1)
        self.assertEqual("+", ul['table'][0]['E-Reader E-mail']['text'])
        self.assertEqual("muki1al@b.com", ul['table'][8]['E-Reader E-mail']['text'])
        ul['header'][4]['sort'].click()
        ul = self.get_user_table(-1)
        self.assertEqual("muki8al@bcd.com", ul['table'][0]['E-Reader E-mail']['text'])
        self.assertEqual("Locale", ul['header'][5]['text'])
