...
class TestEditBooksList(TestCase, ui_class):
    ...
    def test_search_books_list(self):
        ...
        bl = self.check_search(bl, "", 10, "Languages", "English")
    ...
    def test_bookslist_edit_languages(self):
        ...
        self.edit_table_element(bl['table'][4]['Languages']['element'], "German")
        bl = self.get_books_list(-1)
        self.assertEqual("German", bl['table'][4]['Languages']['text'])
        self.edit_table_element(bl['table'][4]['Languages']['element'], "+")
        ...
        bl = self.get_books_list(-1)
        self.assertEqual("German", bl['table'][4]['Languages']['text'])
        self.edit_table_element(bl['table'][4]['Languages']['element'], " English,  German   , fReNcH  ")
        bl = self.get_books_list(-1)
        self.assertEqual("German, English, French", bl['table'][4]['Languages']['text'])
    ...
    def test_bookslist_edit_seriesindex(self):
        ...
        self.edit_table_element(bl['table'][4]['Series Index']['element'], "2")
        bl = self.get_books_list(-1)
        self.assertEqual("2", bl['table'][4]['Series Index']['text'])
        self.edit_table_element(bl['table'][4]['Series Index']['element'], "+")
        time.sleep(1)
        ...
        bl = self.get_books_list(-1)
        self.assertEqual("2", bl['table'][4]['Series Index']['text'])
        self.edit_table_element(bl['table'][4]['Series Index']['element'], "2.009")
        self.assertTrue(self.check_element_on_page((By.XPATH,
                                                          "//button[contains(@class,'editable-submit')]")))
        self.check_element_on_page((By.XPATH,"//button[contains(@class,'editable-cancel')]")).click()
        bl = self.get_books_list(-1)
        self.assertEqual("2", bl['table'][4]['Series Index']['text'])
        self.edit_table_element(bl['table'][4]['Series Index']['element'], "2,01")
        bl = self.get_books_list(-1)
        self.assertEqual("2.01", bl['table'][4]['Series Index']['text'])
        self.edit_table_element(bl['table'][4]['Series Index']['element'], "1.99")
        bl = self.get_books_list(-1)
        self.assertEqual("1.99", bl['table'][4]['Series Index']['text'])
