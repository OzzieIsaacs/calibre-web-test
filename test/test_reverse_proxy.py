...
class TestReverseProxy(ParallelTestCase):
    ...
    def setUpClass(cls):
        ...
        try:
            ...
            time.sleep(3)
            cls.driver.get('http://127.0.0.1:{}/cw'.format(cls.port))
    ...
    def tearDownClass(cls):
        cls.proxy.stop()
        cls.driver.get('http://' + get_Host_IP() + ':' + cls.worker_port)
