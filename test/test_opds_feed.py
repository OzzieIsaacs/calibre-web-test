...
class TestOPDSFeed(unittest.TestCase, ui_class):
    ...
    def test_opds_books(self):
        ...
        self.assertEqual(200, r.status_code)
        elements = self.get_opds_index(r.text)
        r = requests.get('http://127.0.0.1:8083' + elements['Alphabetical Books']['link'], auth=('admin', 'admin123'))
        entries = self.get_opds_feed(r.text)
    ...
    def test_opds_non_admin(self):
        ...
        self.assertEqual(401, r.status_code)
        r = requests.get('http://127.0.0.1:8083/opds', auth=('opds', '123AbC*!'))
        self.assertEqual(200, r.status_code)
        elements = self.get_opds_index(r.text)
        r = requests.get('http://127.0.0.1:8083'+elements['Authors']['link'], auth=('opds', '123AbC*!'))
        self.assertEqual(200, r.status_code)
        r = requests.get('http://127.0.0.1:8083'+elements['Top Rated Books']['link'], auth=('opds', '123AbC*!'))
        self.assertEqual(200, r.status_code)
        r = requests.get('http://127.0.0.1:8083'+elements['Categories']['link'], auth=('opds', '123AbC*!'))
        self.assertEqual(200, r.status_code)
        r = requests.get('http://127.0.0.1:8083'+elements['Hot Books']['link'], auth=('opds', '123AbC*!'))
        self.assertEqual(200, r.status_code)
        r = requests.get('http://127.0.0.1:8083'+elements['Recently added Books']['link'], auth=('opds', '123AbC*!'))
        self.assertEqual(200, r.status_code)
        r = requests.get('http://127.0.0.1:8083'+elements['Shelves']['link'], auth=('opds', '123AbC*!'))
        self.assertEqual(200, r.status_code)
        r = requests.get('http://127.0.0.1:8083'+elements['Publishers']['link'], auth=('opds', '123AbC*!'))
        self.assertEqual(200, r.status_code)
        r = requests.get('http://127.0.0.1:8083'+elements['Random Books']['link'], auth=('opds', '123AbC*!'))
        self.assertEqual(200, r.status_code)
        r = requests.get('http://127.0.0.1:8083'+elements['Series']['link'], auth=('opds', '123AbC*!'))
        self.assertEqual(200, r.status_code)
        r = requests.get('http://127.0.0.1:8083'+elements['Languages']['link'], auth=('opds', '123AbC*!'))
        self.assertEqual(200, r.status_code)
        r = requests.get('http://127.0.0.1:8083'+elements['File formats']['link'], auth=('opds', '123AbC*!'))
        self.assertEqual(200, r.status_code)
        r = requests.get('http://127.0.0.1:8083'+elements['Ratings']['link'], auth=('opds', '123AbC*!'))
        self.assertEqual(200, r.status_code)
    ...
    def test_opds_unicode_user(self):
        ...
        self.logout()
        r = requests.get('http://127.0.0.1:8083/opds', auth=('一执'.encode('utf-8'), '123AbC*!'))
        self.assertEqual(200, r.status_code)
        self.login("admin", "admin123")
    ...
    def test_opds_colon_password(self):
        ...
        self.assertTrue(self.check_element_on_page((By.ID, "flash_success")))
        self.logout()
        r = requests.get('http://127.0.0.1:8083/opds', auth=('usi', '12:34123AbC*!'))
        self.assertEqual(200, r.status_code)
        r = requests.get('http://127.0.0.1:8083/opds', auth=('uv:i', '1234123AbC*!'))
    ...
    def test_opds_download_book(self):
        ...
        self.logout()
        r = requests.get('http://127.0.0.1:8083' + entries['elements'][0]['download'], auth=('opdsdown', '123AbC*!'))
        self.assertEqual(403, r.status_code)
