...
class TestLogin(unittest.TestCase, ui_class):
    ...
    def test_login_protected(self):
        ...
        self.assertEqual(self.fail_access_page(host + "/admin/user/resetpassword/1"), 2)
        self.assertEqual(self.fail_access_page(host + "/admin/book"), 2)
        self.assertEqual(self.fail_access_page(host + "/admin/book/1"), 1)
        self.assertEqual(self.fail_access_page(host + "/upload"), 2)
        self.assertEqual(self.fail_access_page(host + "/admin/convert"), 2)
        self.assertEqual(self.fail_access_page(host + "/admin/convert/1"), 2)
        ...
        self.assertEqual(self.fail_access_page(host + "/ajax/editdomain"), 2)
        self.assertEqual(self.fail_access_page(host + "/ajax/deletedomain"), 2)
        self.assertEqual(self.fail_access_page(host + "/ajax/domainlist"), 2)
        self.assertEqual(self.fail_access_page(host + "/ajax/toggleread"), 2)
        self.assertEqual(self.fail_access_page(host + "/ajax/bookmark/1/1"), 2)
        ...
        self.assertEqual(self.fail_access_page(host + "/books/newest"), 2)
        self.assertEqual(self.fail_access_page(host + "/books/newest/2"), 2)
        self.assertEqual(self.fail_access_page(host + "/books/newest/page/2"), 2)
        self.assertEqual(self.fail_access_page(host + "/books/newest/2"), 2)
        self.assertEqual(self.fail_access_page(host + "/books/oldest"), 2)
        self.assertEqual(self.fail_access_page(host + "/books/oldest/page/2"), 2)
        self.assertEqual(self.fail_access_page(host + "/books/oldest/2"), 2)
        self.assertEqual(self.fail_access_page(host + "/books/a-z"), 2)
        self.assertEqual(self.fail_access_page(host + "/books/a-z/page/2"), 2)
        self.assertEqual(self.fail_access_page(host + "/books/a-z/2"), 2)
        self.assertEqual(self.fail_access_page(host + "/books/hot"), 2)
        self.assertEqual(self.fail_access_page(host + "/books/hot/page/2"), 2)
        self.assertEqual(self.fail_access_page(host + "/books/hot/2"), 2)
        self.assertEqual(self.fail_access_page(host + "/books/rated"), 2)
        self.assertEqual(self.fail_access_page(host + "/books/rated/page/2"), 2)
        self.assertEqual(self.fail_access_page(host + "/books/rated/2"), 2)
        self.assertEqual(self.fail_access_page(host + "/books/discover"), 2)
        self.assertEqual(self.fail_access_page(host + "/books/discover/page/2"), 2)
        self.assertEqual(self.fail_access_page(host + "/books/discover/2"), 2)
        self.assertEqual(self.fail_access_page(host + "/books/author"), 2)
        self.assertEqual(self.fail_access_page(host + "/books/author/page/2"), 2)
        self.assertEqual(self.fail_access_page(host + "/books/author/2"), 2)
        self.assertEqual(self.fail_access_page(host + "/books/series"), 2)
        self.assertEqual(self.fail_access_page(host + "/books/series/page/2"), 2)
        self.assertEqual(self.fail_access_page(host + "/books/series/2"), 2)
        self.assertEqual(self.fail_access_page(host + "/books/language"), 2)
        self.assertEqual(self.fail_access_page(host + "/books/language/page/2"), 2)
        self.assertEqual(self.fail_access_page(host + "/books/language/2"), 2)
        self.assertEqual(self.fail_access_page(host + "/books/category"), 2)
        self.assertEqual(self.fail_access_page(host + "/books/category/page/2"), 2)
        self.assertEqual(self.fail_access_page(host + "/books/category/2"), 2)
        self.assertEqual(self.fail_access_page(host + "/unreadbooks"), 2)
        self.assertEqual(self.fail_access_page(host + "/unreadbooks/2"), 2)
        self.assertEqual(self.fail_access_page(host + "/unreadbooks/page/2"), 2)
        self.assertEqual(self.fail_access_page(host + "/readbooks"), 2)
        self.assertEqual(self.fail_access_page(host + "/readbooks/2"), 2)
        self.assertEqual(self.fail_access_page(host + "/readbooks/page/2"), 2)
        self.assertEqual(self.fail_access_page(host + "/delete"), 2)
        self.assertEqual(self.fail_access_page(host + "/delete/1"), 2)
        self.assertEqual(self.fail_access_page(host + "/delete/1/EPUB"), 2)
        ...
        self.assertEqual(self.fail_access_page(host + "/gdrive/watch"), 2)
        ...
        self.assertEqual(self.fail_access_page(host + "/ajax/verify_token"), 2)
        self.assertEqual(self.fail_access_page(host + "/send/66"), 2)
        self.assertEqual(self.fail_access_page(host + "/shelf/add"), 2)
        self.assertEqual(self.fail_access_page(host + "/shelf/add/1/1"), 2)
        self.assertEqual(self.fail_access_page(host + "/shelf/massadd"), 2)
        self.assertEqual(self.fail_access_page(host + "/shelf/remove"), 2)
        self.assertEqual(self.fail_access_page(host + "/shelf/remove/1/1"), 2)
        self.assertEqual(self.fail_access_page(host + "/shelf/create"), 1)
        self.assertEqual(self.fail_access_page(host + "/shelf/delete"), 2)
        self.assertEqual(self.fail_access_page(host + "/shelf/delete/1"), 2)
        ...
        self.assertEqual(self.fail_access_page(host + "/admin"), 2)
        ...
        self.assertEqual(self.fail_access_page(host + "/admin/resetpassword/0"), 2)
